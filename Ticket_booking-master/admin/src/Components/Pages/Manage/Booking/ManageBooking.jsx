...
const ManageBooking = () => {
  ...
  const handleDownload = () => {
    ...
    // Map data for Excel
    const data = sortedBookings
      .filter((value) => value.bookingStatus === "Booked")
      .map((item, index) => ({
        "S.no": index + 1,
        ...
        PNR: item.PNR,
        Price: item.price,
        "Date/Time":dateTime(item.createdAt)
      }));
    ...
    saveAs(fileData, `booking-${booking.date}.xlsx`);
  };

  const booked = booking?.bookings?.filter(
    (value) => value.bookingStatus === "Booked"
  );
        ...
        <div className="card" style={{ width: "100%" }}>
          <div className="card-body" style={{ padding: "20px" }}>
            ...
            <div className="booking-package package-facilities-section">
              <p>Select the Date for view Booking</p>
